        ...
        <div class="main-content">
            ...
            <article class="about active" data-page="about">
                ...
                <section class="service">
                    ...
                    <ul class="service-list">
                        ...
                        <li class="service-item">
                            ...
                            <div class="service-content-box">
                                <h4 class="h4 service-item-title">VIENDO PACIENTES:</h4>
                     ...
                     <div class="service-content-box">
                        <h4 class="h4 service-item-title">HORARIOS</h4>
                        <h4 class="h4 service-item-title"><?php echo $data["horarios"]; ?>.</h4>
                        <h5 class="h4 service-item-title"><?php echo $data["fechas_consul"]; ?></h5>
                            </div>
                        </li>
                ...
                <!-- <section class="clients">
                    <h3 class="h3 clients-title">Aliados Comerciales</h3>

                    <ul class="clients-list has-scrollbar">
                        <li class="clients-item">
                            <a href="#"><img src="img/2047x800.png" alt="logo"></a>
                        </li>
